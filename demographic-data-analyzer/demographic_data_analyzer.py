...
def calculate_demographic_data(print_data=True):
    ...
    countries_rich_percentage = (df[rich]['native-country'].value_counts() / df['native-country'].value_counts() * 100).sort_values(ascending=False)
    highest_earning_country = countries_rich_percentage.index[0]
    highest_earning_country_percentage = round(countries_rich_percentage.iloc[0], 1)
